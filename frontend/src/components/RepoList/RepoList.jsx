...
import { Trash2, FolderGit2, Star, StarOff } from "lucide-react";

export default function RepoList({ repos, favorites, onRepoClick, onDeleteClick, onToggleFavorite }) {
  if (!repos.length) {
    return (
  ...
  return (
    <div className="space-y-2">
      ...
      {repos.map((repo) => {
        const isFav = favorites.includes(repo._id);
        return (
          <Card
            key={repo._id}
